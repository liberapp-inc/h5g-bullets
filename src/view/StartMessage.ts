...
class StartMessage extends GameObject{
    ...
    constructor() {
        ...
        this.texts[0] = Util.newTextField("弾幕天国", Util.width / 12, FONT_COLOR, 0.5, 0.3, true, false);
        this.texts[1] = Util.newTextField("ボールを動かして弾幕をよけろ！", Util.width / 18, FONT_COLOR, 0.5, 0.4, true, false);
